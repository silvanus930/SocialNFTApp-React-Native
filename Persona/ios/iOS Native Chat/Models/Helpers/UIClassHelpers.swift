//
//  UIClassHelpers.swift
//  Persona
//
//  Created by Allan Zhang on 2/9/23.
//
...
extension String {
    ...
    //Gets height of string with constrained width and font (perfect for with photos and other size-fit items)
    //ceil is the ceiling height
